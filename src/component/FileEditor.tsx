...
interface Props {
    ...
    onSave?: (f: FileI) => void
    onScroll?: (dom: HTMLDivElement, source: string) => void
}
...
export default function FileEditor(props: Props) {
    ...
    return <div className="flex h-full flex-col" onKeyDownCapture={(e) => {
        ...
        <div
            ...
            onScroll={
                (e) => {
                    props.onScroll?.(e.target as HTMLDivElement, body)
                }
            }
        >
